...
The Reset Password Mail Page is used for sending the reset password link to the requesting uer (see also [*Reset Password Page*](./Reset%20Password%20Page.md)). The page consists of a subject line, main body element and a main content area.
...
--------------|------|---------------
**Subject** *(`Subject`)* | String | Provides an area the subject line of the email. 
